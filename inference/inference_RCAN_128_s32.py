...
def main():
    ...
    # set up model
    model = RCAN(num_in_ch=3, num_out_ch=3, num_feat=128, num_group=10, num_block=20, squeeze_factor=32, upscale=3, res_scale=1, img_range=255., rgb_mean=[0.4488, 0.4371, 0.4040])
